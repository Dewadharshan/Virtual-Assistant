...
def find_text_on_screen(text):
    ...
    myscreenshot.save(r"D:\\mini_project\\temp\\screenshot.png")
...
def mute_volume():
    keyboard = Controller()
    try:
        speak("The volume has been muted")
...
def introduction():
    speak("hello. I am a voice assistant specifically available on windows")
    speak("I can do anything you do on your computer")
    speak("you just need to command me ")
    speak("and I will do the rest")
